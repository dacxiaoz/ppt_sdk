(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('canvas')) :
	typeof define === 'function' && define.amd ? define(['canvas'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ppt_sdk = factory(global.canvas));
})(this, (function (canvas) { 'use strict';
	...
	exports.Util = {
	    ...
	    _getRotation(radians) {
	        return Global.Konva.angleDeg ? exports.Util.radToDeg(radians) : radians;
	    },
	    _capitalize(str) {
	...
	function getNumberOrArrayOfNumbersValidator(noOfElements) {
	    if (Global.Konva.isUnminified) {
	        return function (val, attr) {
	            let isNumber = Util.Util._isNumber(val);
	            let isValidArray = Util.Util._isArray(val) && val.length == noOfElements;
	...
	function getStringOrGradientValidator() {
	    if (Global.Konva.isUnminified) {
	        return function (val, attr) {
	            const isString = Util.Util._isString(val);
	...
	Validators.getComponentValidator;
	Validators.getBooleanValidator;
	Validators.getNumberArrayValidator;
	Validators.getFunctionValidator;
	Validators.getStringOrGradientValidator;
	...
	exports.Factory = {
	    ...
	    addComponentsGetterSetter(constructor, attr, components, validator, after) {
	        ...
	        var basicValidator = (0, Validators.getComponentValidator)(components);
	...
	function simplifyArray(arr) {
	    var retArr = [], len = arr.length, util = Util.Util, n, val;
	    for (n = 0; n < len; n++) {
	        val = arr[n];
	...
	Context_1.HitContext;
	Context_1.SceneContext;
	Context_1.Context;
	...
	Factory.Factory.addGetterSetter(Canvas, 'pixelRatio', undefined, (0, Validators.getNumberValidator)());
	    ...
	    _endDragBefore(evt) {
	        ...
	        exports.DD._dragElements.forEach((elem) => {
	            ...
	            if (elem.dragStatus === 'dragging' || elem.dragStatus === 'stopped') {
	                ...
	                Global.Konva._mouseListenClick = false;
	                Global.Konva._touchListenClick = false;
	                Global.Konva._pointerListenClick = false;
	...
	class Node {
	    ...
	    shouldDrawHit(top, skipDragCheck = false) {
	        ...
	        DragAndDrop.DD._dragElements.forEach((elem) => {
	            if (elem.dragStatus !== 'dragging') {
	                return;
	            }
	    ...
	    startDrag(evt, bubbleEvent = true) {
	        ...
	        const elem = DragAndDrop.DD._dragElements.get(this._id);
	    ...
	    _dragChange() {
	        if (this.attrs.draggable) {
	            ...
	            const dragElement = DragAndDrop.DD._dragElements.get(this._id);
	    ...
	    isClientRectOnScreen(margin = { x: 0, y: 0 }) {
	        ...
	        return Util.Util.haveIntersection(screenRect, this.getClientRect());
	    }
	    ...
	    static _createNode(obj, container) {
	        ...
	        if (!Global.Konva[className]) {
	            Util.Util.warn('Can not find a node with class name "' +
	                className +
	                '". Fallback to "Shape".');
	            className = 'Shape';
	        }
	        const Class = Global.Konva[className];
	...
	const addGetterSetter = Factory.Factory.addGetterSetter;
	addGetterSetter(Node, 'zIndex');
	addGetterSetter(Node, 'absolutePosition');
	addGetterSetter(Node, 'position');
	addGetterSetter(Node, 'x', 0, (0, Validators.getNumberValidator)());
	addGetterSetter(Node, 'y', 0, (0, Validators.getNumberValidator)());
	addGetterSetter(Node, 'globalCompositeOperation', 'source-over', (0, Validators.getStringValidator)());
	addGetterSetter(Node, 'opacity', 1, (0, Validators.getNumberValidator)());
	addGetterSetter(Node, 'name', '', (0, Validators.getStringValidator)());
	addGetterSetter(Node, 'id', '', (0, Validators.getStringValidator)());
	addGetterSetter(Node, 'rotation', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addComponentsGetterSetter(Node, 'scale', ['x', 'y']);
	addGetterSetter(Node, 'scaleX', 1, (0, Validators.getNumberValidator)());
	addGetterSetter(Node, 'scaleY', 1, (0, Validators.getNumberValidator)());
	Factory.Factory.addComponentsGetterSetter(Node, 'skew', ['x', 'y']);
	addGetterSetter(Node, 'skewX', 0, (0, Validators.getNumberValidator)());
	addGetterSetter(Node, 'skewY', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addComponentsGetterSetter(Node, 'offset', ['x', 'y']);
	addGetterSetter(Node, 'offsetX', 0, (0, Validators.getNumberValidator)());
	addGetterSetter(Node, 'offsetY', 0, (0, Validators.getNumberValidator)());
	addGetterSetter(Node, 'dragDistance', null, (0, Validators.getNumberValidator)());
	addGetterSetter(Node, 'width', 0, (0, Validators.getNumberValidator)());
	addGetterSetter(Node, 'height', 0, (0, Validators.getNumberValidator)());
	addGetterSetter(Node, 'listening', true, (0, Validators.getBooleanValidator)());
	addGetterSetter(Node, 'preventDefault', true, (0, Validators.getBooleanValidator)());
	addGetterSetter(Node, 'filters', null, function (val) {
	    this._filterUpToDate = false;
	    return val;
	});
	addGetterSetter(Node, 'visible', true, (0, Validators.getBooleanValidator)());
	addGetterSetter(Node, 'transformsEnabled', 'all', (0, Validators.getStringValidator)());
	addGetterSetter(Node, 'size');
	addGetterSetter(Node, 'dragBoundFunc');
	addGetterSetter(Node, 'draggable', false, (0, Validators.getBooleanValidator)());
	...
	Factory.Factory.addGetterSetter(Container, 'clipX', undefined, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Container, 'clipY', undefined, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Container, 'clipWidth', undefined, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Container, 'clipHeight', undefined, (0, Validators.getNumberValidator)());
	...
	const SUPPORT_POINTER_EVENTS = Global.Konva._global['PointerEvent'] !== undefined;
	...
	PointerEvents.releaseCapture;
	PointerEvents.setPointerCapture;
	PointerEvents.hasPointerCapture;
	PointerEvents.createEvent;
	PointerEvents.getCapturedShape;
	...
	const getEventsMap = (eventType) => {
	    ...
	    if (type === 'pointer') {
	        return Global.Konva.pointerEventsEnabled && EVENTS_MAP.pointer;
	    }
	    if (type === 'touch') {
	...
	class Stage extends Container_1.Container {
	    ...
	    _pointerdown(evt) {
	        ...
	        this._changedPointerPositions.forEach((pos) => {
	            ...
	            Global.Konva['_' + eventType + 'ListenClick'] = true;
	            const hasShape = shape && shape.isListening();
	            if (!hasShape) {
	                return;
	            }
	            if (Global.Konva.capturePointerEventsEnabled) {
	    ...
	    _pointerup(evt) {
	        ...
	        this._changedPointerPositions.forEach((pos) => {
	            ...
	            if (Global.Konva['_' + eventType + 'InDblClickWindow']) {
	                fireDblClick = true;
	                clearTimeout(this[eventType + 'DblTimeout']);
	            }
	            else if (!DragAndDrop.DD.justDragged) {
	                Global.Konva['_' + eventType + 'InDblClickWindow'] = true;
	                clearTimeout(this[eventType + 'DblTimeout']);
	            }
	            this[eventType + 'DblTimeout'] = setTimeout(function () {
	                Global.Konva['_' + eventType + 'InDblClickWindow'] = false;
	            }, Global.Konva.dblClickWindow);
	            if (shape && shape.isListening()) {
	                triggeredOnShape = true;
	                this[eventType + 'ClickEndShape'] = shape;
	                shape._fireAndBubble(events.pointerup, Object.assign({}, event));
	                if (Global.Konva['_' + eventType + 'ListenClick'] &&
	                    clickStartShape &&
	        ...
	        Global.Konva['_' + eventType + 'ListenClick'] = false;
	...
	class Shape extends Node_1.Node {
	    ...
	    getContext() {
	        Util.Util.warn('shape.getContext() method is deprecated. Please do not use it.');
	        return this.getLayer().getContext();
	    }
	    getCanvas() {
	        Util.Util.warn('shape.getCanvas() method is deprecated. Please do not use it.');
	    ...
	    __getFillPattern() {
	        if (this.fillPatternImage()) {
	            ...
	            if (pattern && pattern.setTransform) {
	                const tr = new Util.Transform();
	                tr.translate(this.fillPatternX(), this.fillPatternY());
	                tr.rotate(Global.Konva.getAngle(this.fillPatternRotation()));
	    ...
	    drawHit(can, top, skipDragCheck = false) {
	        ...
	        if (!this.colorKey) {
	            Util.Util.warn('Looks like your canvas has a destroyed shape in it. Do not reuse shape after you destroyed it. If you want to reuse shape you should call remove() instead of destroy()');
	        }
	        if (cachedHitCanvas) {
	            context.save();
	            var m = this.getAbsoluteTransform(top).getMatrix();
	...
	Factory.Factory.addGetterSetter(Shape, 'stroke', undefined, (0, Validators.getStringOrGradientValidator)());
	Factory.Factory.addGetterSetter(Shape, 'strokeWidth', 2, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Shape, 'fillAfterStrokeEnabled', false);
	Factory.Factory.addGetterSetter(Shape, 'hitStrokeWidth', 'auto', (0, Validators.getNumberOrAutoValidator)());
	Factory.Factory.addGetterSetter(Shape, 'strokeHitEnabled', true, (0, Validators.getBooleanValidator)());
	Factory.Factory.addGetterSetter(Shape, 'perfectDrawEnabled', true, (0, Validators.getBooleanValidator)());
	Factory.Factory.addGetterSetter(Shape, 'shadowForStrokeEnabled', true, (0, Validators.getBooleanValidator)());
	...
	Factory.Factory.addGetterSetter(Shape, 'dashOffset', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Shape, 'shadowColor', undefined, (0, Validators.getStringValidator)());
	Factory.Factory.addGetterSetter(Shape, 'shadowBlur', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Shape, 'shadowOpacity', 1, (0, Validators.getNumberValidator)());
	Factory.Factory.addComponentsGetterSetter(Shape, 'shadowOffset', ['x', 'y']);
	Factory.Factory.addGetterSetter(Shape, 'shadowOffsetX', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Shape, 'shadowOffsetY', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Shape, 'fillPatternImage');
	Factory.Factory.addGetterSetter(Shape, 'fill', undefined, (0, Validators.getStringOrGradientValidator)());
	Factory.Factory.addGetterSetter(Shape, 'fillPatternX', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Shape, 'fillPatternY', 0, (0, Validators.getNumberValidator)());
	...
	Factory.Factory.addGetterSetter(Shape, 'fillPatternOffsetX', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Shape, 'fillPatternOffsetY', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addComponentsGetterSetter(Shape, 'fillPatternScale', ['x', 'y']);
	Factory.Factory.addGetterSetter(Shape, 'fillPatternScaleX', 1, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Shape, 'fillPatternScaleY', 1, (0, Validators.getNumberValidator)());
	...
	class Layer extends Container_1.Container {
	    ...
	    _getIntersection(pos) {
	        ...
	        const p3 = p[3];
	        if (p3 === 255) {
	            const colorKey = Util.Util._rgbToHex(p[0], p[1], p[2]);
	...
	Factory.Factory.addGetterSetter(Layer, 'hitGraphEnabled', true, (0, Validators.getBooleanValidator)());
	});
	...
	(0, Global._registerNode)(FastLayer);
	});

	unwrapExports(FastLayer_1);
	FastLayer_1.FastLayer;
	...
	class Animation {
	    ...
	    static _animationLoop() {
	        ...
	        if (Anim.animations.length) {
	            Anim._runFrames();
	            Util.Util.requestAnimFrame(Anim._animationLoop);
	        }
	        else {
	    ...
	    static _handleAnimation() {
	        if (!this.animRunning) {
	            ...
	            Util.Util.requestAnimFrame(this._animationLoop);
	        }
	    }
	}
	...
	class Arc extends Shape_1.Shape {
	    ...
	    getSelfRect() {
	        ...
	        const angle = Global.Konva.getAngle(clockwise ? 360 - this.angle() : this.angle());
	...
	Factory.Factory.addGetterSetter(Arc, 'innerRadius', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Arc, 'outerRadius', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Arc, 'angle', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Arc, 'clockwise', false, (0, Validators.getBooleanValidator)());
	});
	...
	(0, Global._registerNode)(Line);
	Factory.Factory.addGetterSetter(Line, 'closed', false);
	Factory.Factory.addGetterSetter(Line, 'bezier', false);
	Factory.Factory.addGetterSetter(Line, 'tension', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Line, 'points', [], (0, Validators.getNumberArrayValidator)());
	});
	...
	(0, Global._registerNode)(Arrow);
	Factory.Factory.addGetterSetter(Arrow, 'pointerLength', 10, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Arrow, 'pointerWidth', 10, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Arrow, 'pointerAtBeginning', false);
	Factory.Factory.addGetterSetter(Arrow, 'pointerAtEnding', true);
	});
	...
	(0, Global._registerNode)(Circle);
	Factory.Factory.addGetterSetter(Circle, 'radius', 0, (0, Validators.getNumberValidator)());
	});
	...
	(0, Global._registerNode)(Ellipse);
	Factory.Factory.addComponentsGetterSetter(Ellipse, 'radius', ['x', 'y']);
	Factory.Factory.addGetterSetter(Ellipse, 'radiusX', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Ellipse, 'radiusY', 0, (0, Validators.getNumberValidator)());
	});
	...
	(0, Global._registerNode)(Image);
	Factory.Factory.addGetterSetter(Image, 'image');
	Factory.Factory.addComponentsGetterSetter(Image, 'crop', ['x', 'y', 'width', 'height']);
	Factory.Factory.addGetterSetter(Image, 'cropX', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Image, 'cropY', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Image, 'cropWidth', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Image, 'cropHeight', 0, (0, Validators.getNumberValidator)());
	});
	...
	(0, Global._registerNode)(Tag);
	Factory.Factory.addGetterSetter(Tag, 'pointerDirection', NONE);
	Factory.Factory.addGetterSetter(Tag, 'pointerWidth', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Tag, 'pointerHeight', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Tag, 'cornerRadius', 0, (0, Validators.getNumberOrArrayOfNumbersValidator)(4));
	});
	...
	(0, Global._registerNode)(Rect);
	Factory.Factory.addGetterSetter(Rect, 'cornerRadius', 0, (0, Validators.getNumberOrArrayOfNumbersValidator)(4));
	});
	...
	(0, Global._registerNode)(RegularPolygon);
	Factory.Factory.addGetterSetter(RegularPolygon, 'radius', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(RegularPolygon, 'sides', 0, (0, Validators.getNumberValidator)());
	});
	...
	(0, Global._registerNode)(Ring);
	Factory.Factory.addGetterSetter(Ring, 'innerRadius', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Ring, 'outerRadius', 0, (0, Validators.getNumberValidator)());
	});
	...
	Factory.Factory.addGetterSetter(Sprite, 'frameIndex', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Sprite, 'frameRate', 17, (0, Validators.getNumberValidator)());
	...
	(0, Global._registerNode)(Star);
	Factory.Factory.addGetterSetter(Star, 'numPoints', 5, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Star, 'innerRadius', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Star, 'outerRadius', 0, (0, Validators.getNumberValidator)());
	});
	...
	(0, Global._registerNode)(Text);
	Factory.Factory.overWriteSetter(Text, 'width', (0, Validators.getNumberOrAutoValidator)());
	Factory.Factory.overWriteSetter(Text, 'height', (0, Validators.getNumberOrAutoValidator)());
	Factory.Factory.addGetterSetter(Text, 'fontFamily', 'Arial');
	Factory.Factory.addGetterSetter(Text, 'fontSize', 12, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Text, 'fontStyle', NORMAL);
	Factory.Factory.addGetterSetter(Text, 'fontVariant', NORMAL);
	Factory.Factory.addGetterSetter(Text, 'padding', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Text, 'align', LEFT);
	Factory.Factory.addGetterSetter(Text, 'verticalAlign', TOP);
	Factory.Factory.addGetterSetter(Text, 'lineHeight', 1, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Text, 'wrap', WORD);
	Factory.Factory.addGetterSetter(Text, 'ellipsis', false, (0, Validators.getBooleanValidator)());
	Factory.Factory.addGetterSetter(Text, 'letterSpacing', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Text, 'text', '', (0, Validators.getStringValidator)());
	Factory.Factory.addGetterSetter(Text, 'textDecoration', '');
	});

	unwrapExports(Text_1);
	Text_1.Text;
	Text_1.stringToArray;
	...
	class TextPath extends Shape_1.Shape {
	    constructor(config) {
	        super(config);
	        this.dummyCanvas = Util.Util.createCanvasElement();
	        this.dataArray = [];
	...
	const TOUCH_DEVICE = 'ontouchstart' in Global.Konva._global;
	function getCursor(anchorName, rad) {
	    if (anchorName === 'rotater') {
	        return 'crosshair';
	    }
	    rad += Util.Util.degToRad(ANGLES[anchorName] || 0);
	    var angle = ((Util.Util.radToDeg(rad) % 360) + 360) % 360;
	...
	function getSnap(snaps, newRotationRad, tol) {
	    ...
	    for (let i = 0; i < snaps.length; i++) {
	        const angle = Global.Konva.getAngle(snaps[i]);
	...
	class Transformer extends Group_1.Group {
	    ...
	    __getNodeShape(node, rot = this.rotation(), relative) {
	        ...
	        const rotation = (Global.Konva.getAngle(node.getAbsoluteRotation()) + Math.PI * 2) %
	            (Math.PI * 2);
	        const box = {
	    ...
	    _createAnchor(name) {
	        ...
	        anchor.on('mouseenter', () => {
	            var rad = Global.Konva.getAngle(this.rotation());
	    ...
	    _handleMouseMove(e) {
	        ...
	        if (this._movingAnchorName === 'rotater') {
	            ...
	            const tol = Global.Konva.getAngle(this.rotationSnapTolerance());
	    ...
	    _fitNodesInto(newAttrs, evt) {
	        ...
	        const oldTr = new Util.Transform();
	        oldTr.translate(oldAttrs.x, oldAttrs.y);
	        oldTr.rotate(oldAttrs.rotation);
	        oldTr.scale(oldAttrs.width / baseSize, oldAttrs.height / baseSize);
	        const newTr = new Util.Transform();
	        ...
	        this._nodes.forEach((node) => {
	            ...
	            const newLocalTransform = new Util.Transform();
	            newLocalTransform
	...
	Factory.Factory.addGetterSetter(Transformer, 'flipEnabled', true, (0, Validators.getBooleanValidator)());
	Factory.Factory.addGetterSetter(Transformer, 'resizeEnabled', true);
	Factory.Factory.addGetterSetter(Transformer, 'anchorSize', 10, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Transformer, 'rotateEnabled', true);
	Factory.Factory.addGetterSetter(Transformer, 'rotationSnaps', []);
	Factory.Factory.addGetterSetter(Transformer, 'rotateAnchorOffset', 50, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Transformer, 'rotationSnapTolerance', 5, (0, Validators.getNumberValidator)());
	...
	Factory.Factory.addGetterSetter(Transformer, 'anchorStrokeWidth', 1, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Transformer, 'anchorFill', 'white');
	Factory.Factory.addGetterSetter(Transformer, 'anchorCornerRadius', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Transformer, 'borderStroke', 'rgb(0, 161, 255)');
	Factory.Factory.addGetterSetter(Transformer, 'borderStrokeWidth', 1, (0, Validators.getNumberValidator)());
	...
	Factory.Factory.addGetterSetter(Transformer, 'padding', 0, (0, Validators.getNumberValidator)());
	...
	Factory.Factory.addGetterSetter(Transformer, 'anchorDragBoundFunc');
	Factory.Factory.addGetterSetter(Transformer, 'shouldOverdrawWholeArea', false);
	Factory.Factory.addGetterSetter(Transformer, 'useSingleNodeRotation', true);
	...
	Factory.Factory.addGetterSetter(Wedge, 'radius', 0, (0, Validators.getNumberValidator)());
	Factory.Factory.addGetterSetter(Wedge, 'angle', 0, (0, Validators.getNumberValidator)());
	...
	exports.Blur = Blur;
	Factory.Factory.addGetterSetter(Node_1.Node, 'blurRadius', 0, (0, Validators.getNumberValidator)(), Factory.Factory.afterSetFilter);
	});

	unwrapExports(Blur_1);
	Blur_1.Blur;
	...
	Factory.Factory.addGetterSetter(Node_1.Node, 'brightness', 0, (0, Validators.getNumberValidator)(), Factory.Factory.afterSetFilter);
	});

	unwrapExports(Brighten_1);
	Brighten_1.Brighten;
	...
	Factory.Factory.addGetterSetter(Node_1.Node, 'contrast', 0, (0, Validators.getNumberValidator)(), Factory.Factory.afterSetFilter);
	});

	unwrapExports(Contrast_1);
	Contrast_1.Contrast;
	...
	Factory.Factory.addGetterSetter(Node_1.Node, 'embossStrength', 0.5, (0, Validators.getNumberValidator)(), Factory.Factory.afterSetFilter);
	Factory.Factory.addGetterSetter(Node_1.Node, 'embossWhiteLevel', 0.5, (0, Validators.getNumberValidator)(), Factory.Factory.afterSetFilter);
	...
	Factory.Factory.addGetterSetter(Node_1.Node, 'enhance', 0, (0, Validators.getNumberValidator)(), Factory.Factory.afterSetFilter);
	});
	...
	unwrapExports(Grayscale_1);
	Grayscale_1.Grayscale;
	...
	Factory.Factory.addGetterSetter(Node_1.Node, 'hue', 0, (0, Validators.getNumberValidator)(), Factory.Factory.afterSetFilter);
	Factory.Factory.addGetterSetter(Node_1.Node, 'saturation', 0, (0, Validators.getNumberValidator)(), Factory.Factory.afterSetFilter);
	Factory.Factory.addGetterSetter(Node_1.Node, 'luminance', 0, (0, Validators.getNumberValidator)(), Factory.Factory.afterSetFilter);
	...
	Factory.Factory.addGetterSetter(Node_1.Node, 'hue', 0, (0, Validators.getNumberValidator)(), Factory.Factory.afterSetFilter);
	Factory.Factory.addGetterSetter(Node_1.Node, 'saturation', 0, (0, Validators.getNumberValidator)(), Factory.Factory.afterSetFilter);
	Factory.Factory.addGetterSetter(Node_1.Node, 'value', 0, (0, Validators.getNumberValidator)(), Factory.Factory.afterSetFilter);
	});
	...
	Factory.Factory.addGetterSetter(Node_1.Node, 'kaleidoscopePower', 2, (0, Validators.getNumberValidator)(), Factory.Factory.afterSetFilter);
	Factory.Factory.addGetterSetter(Node_1.Node, 'kaleidoscopeAngle', 0, (0, Validators.getNumberValidator)(), Factory.Factory.afterSetFilter);
	});

	unwrapExports(Kaleidoscope_1);
	Kaleidoscope_1.Kaleidoscope;
	...
	exports.Mask = Mask;
	Factory.Factory.addGetterSetter(Node_1.Node, 'threshold', 0, (0, Validators.getNumberValidator)(), Factory.Factory.afterSetFilter);
	});
	...
	exports.Noise = Noise;
	Factory.Factory.addGetterSetter(Node_1.Node, 'noise', 0.2, (0, Validators.getNumberValidator)(), Factory.Factory.afterSetFilter);
	});
	...
	Factory.Factory.addGetterSetter(Node_1.Node, 'pixelSize', 8, (0, Validators.getNumberValidator)(), Factory.Factory.afterSetFilter);
	});

	unwrapExports(Pixelate_1);
	Pixelate_1.Pixelate;
	...
	Factory.Factory.addGetterSetter(Node_1.Node, 'levels', 0.5, (0, Validators.getNumberValidator)(), Factory.Factory.afterSetFilter);
	});

	unwrapExports(Posterize_1);
	Posterize_1.Posterize;
	...
	Factory.Factory.addGetterSetter(Node_1.Node, 'threshold', 0.5, (0, Validators.getNumberValidator)(), Factory.Factory.afterSetFilter);
	});

	unwrapExports(Threshold_1);
	...
	var indexNode = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });


	const canvas = canvas__default["default"]['default'] || canvas__default["default"];
	commonjsGlobal.DOMMatrix = canvas.DOMMatrix;
	const isNode = typeof commonjsGlobal.document === 'undefined';
	if (isNode) {
	    _FullInternals.Konva.Util['createCanvasElement'] = () => {
	    ...
	    _FullInternals.Konva.Util.createImageElement = () => {
	        const node = new canvas.Image();
	        return node;
	    };
	}
	exports.default = _FullInternals.Konva;
	});

	var Konva = unwrapExports(indexNode);
